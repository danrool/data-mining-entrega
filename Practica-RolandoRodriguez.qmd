...
```{r}
# Definir los nuevos nombres de las columnas como vector
...
# Compruebo cuales on las ciudades en el dataframe
...
12. Vamos a crear dos grupos, uno test y otro train.
    ...
    index <- sample(1:nrow(df_madrid),nrow(df_madrid$Square.Meters)*0.7)

    # Crear conjuntos de entrenamiento y prueba
    df_madrid_train <- df_madrid[index, ]
    df_madrid_test <- df_madrid[-index, ]
...
12. Vamos a crear dos grupos, uno test y otro train.
    ...
    # Crear índices
    # index <- createDataPartition(df_madrid$Square.Meters, p = 0.7, list = FALSE)
    index <- sample(1:nrow(df_madrid),nrow(df_madrid$Square.Meters)*0.7)
...
------------------------------------------------------------------------
>>>>>>> 8954234424679b9d73c9a263271e9a82c2820f96
